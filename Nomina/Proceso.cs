...
namespace Nomina
{
    ...
    class Proceso
    {
        ...
        public void RegistrarEmpleado()
        {
            ...
            String PagoXHoraExtra = Console.ReadLine();
            ...
            String IRPF = Console.ReadLine();
            Console.WriteLine("\nLos Datos Fueron Guardados, ");
            Console.WriteLine("Para su modificacion en el apartado correspondiente");
            Console.WriteLine("\nPresione una Tecla Para el menu de Opciones.");
            id = int.Parse(NumTrabajador);
            Empleado empleado = new Empleado(id, NumTrabajador, NombreCompleto, Cargo, Sueldo, PagoXHoraExtra, EstadoCivil, NumHijos, IRPF) { };
            RecursoHumano RH = new RecursoHumano(100);
            RH.anidarEmpleado(empleado);
